  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 w-full h-screen overflow-hidden">
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-t from-brand-primary via-brand-primary/30 to-transparent pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/40 via-transparent to-brand-primary/20 pointer-events-none" />

        {/* Lime accent bar */}
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-brand-secondary z-10" />

        {/* Hero content */}
        <div className="relative z-10 h-full flex flex-col justify-end pb-16 md:pb-24 px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
          <div className="mb-4">
            <span className="inline-block bg-brand-secondary text-black text-xs font-black uppercase tracking-widest px-3 py-1">
              #4
            </span>
          </div>
          ...
          <p className="text-base md:text-lg lg:text-xl font-medium uppercase tracking-[0.2em] text-brand-secondary mb-8 md:mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8">
            <a
              href="#on-track"
              className="group inline-flex items-center gap-3 bg-brand-secondary text-black font-black uppercase text-sm tracking-widest px-6 py-4 hover:bg-white transition-colors duration-200"
            >
              Explore Season
              <svg
        ...
        {loadingVisible && (
          <div
            className={`absolute inset-0 z-50 bg-brand-primary flex flex-col items-center justify-center gap-6 transition-opacity duration-500 ${
              isLoaded ? 'opacity-0' : 'opacity-100'
            }`}
          >
            <div className="flex flex-col items-center gap-2">
              <span className="text-xs font-black uppercase tracking-[0.4em] text-brand-secondary">#4</span>
            ...
            <div className="relative w-48 h-px bg-white/10 overflow-hidden">
              <div
                className="absolute inset-y-0 left-0 bg-brand-secondary transition-all duration-100 ease-linear"
